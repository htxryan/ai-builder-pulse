...
@/Users/redhale/src/ai-builder-pulse/.gemini/get-shit-done/references/questioning.md
...
```bash
node "/Users/redhale/src/ai-builder-pulse/.gemini/get-shit-done/bin/gsd-tools.cjs" commit "docs: capture exploration — {topic_slug}" --files {file_list}
```
