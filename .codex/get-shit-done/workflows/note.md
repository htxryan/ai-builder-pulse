...
- **Global scope**: `/Users/redhale/src/ai-builder-pulse/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/redhale/src/ai-builder-pulse/.codex/notes/`)
...
2. Glob `/Users/redhale/src/ai-builder-pulse/.codex/notes/*.md` (if directory exists) — global notes
...
Global (/Users/redhale/src/ai-builder-pulse/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/redhale/src/ai-builder-pulse/.codex/notes/` — works in any directory
