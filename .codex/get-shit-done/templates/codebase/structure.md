...
- Usage: Reference from command with `@/Users/redhale/src/ai-builder-pulse/.codex/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/redhale/src/ai-builder-pulse/.codex/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/redhale/src/ai-builder-pulse/.codex/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
