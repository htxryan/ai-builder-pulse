...
Use template from `/Users/redhale/src/ai-builder-pulse/.codex/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `/Users/redhale/src/ai-builder-pulse/.codex/get-shit-done/templates/UI-SPEC.md`
...
```bash
node "/Users/redhale/src/ai-builder-pulse/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs($PHASE): UI design contract" --files "$PHASE_DIR/$PADDED_PHASE-UI-SPEC.md"
```
