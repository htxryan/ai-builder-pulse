...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /Users/redhale/src/ai-builder-pulse/.codex
                  → checks /Users/redhale/src/ai-builder-pulse/.codex/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /Users/redhale/src/ai-builder-pulse/.codex/get-shit-done
                  → writes to /Users/redhale/src/ai-builder-pulse/.codex/get-shit-done/hooks/
...
@/Users/redhale/src/ai-builder-pulse/.codex/get-shit-done/references/thinking-models-debug.md
...
- Read @/Users/redhale/src/ai-builder-pulse/.codex/get-shit-done/references/common-bug-patterns.md
...
```bash
INIT=$(node "/Users/redhale/src/ai-builder-pulse/.codex/get-shit-done/bin/gsd-tools.cjs" state load)
...
```bash
node "/Users/redhale/src/ai-builder-pulse/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: resolve debug {slug}" --files .planning/debug/resolved/{slug}.md
```
...
```bash
node "/Users/redhale/src/ai-builder-pulse/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs: update debug knowledge base with {slug}" --files .planning/debug/knowledge-base.md
```
